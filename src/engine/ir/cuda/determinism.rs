...
#[must_use]
pub fn policy_for(level: DeterminismLevel, phase: ExecutionPhase) -> CudaDeterminismPolicy {
    match level {
        ...
        DeterminismLevel::Balanced => match phase {
            ExecutionPhase::Inference => CudaDeterminismPolicy {
                mode: level,
                phase,
                allow_atomics: false,
                fixed_reduction_topology: true,
            ...
            ExecutionPhase::Training => CudaDeterminismPolicy {
                mode: level,
                phase,
                allow_atomics: true,
        ...
        DeterminismLevel::Fast => CudaDeterminismPolicy {
            mode: level,
            phase,
            allow_atomics: true,
            fixed_reduction_topology: false,
