...
| `docs/ONNX_COVERAGE.md` | ONNX operator status matrix matches runtime behavior | _pending evidence_ | pending | requires targeted fixture verification before RC |
